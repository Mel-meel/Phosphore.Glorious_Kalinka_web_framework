...
##
proc App_route_api {get post {route_html {"encapsuled" ""}}} {
    set template "Templates/api.html"
    ...
    if {$type_retour == "encapsuled"} {
        ...
        set html [list $type_retour "dshjhskhddshjkdhsjs"]
    }
...
##
proc App_route_css_api {{css "null"}} {
    set css_liste [list]
    if {$css != "null"} {
